        ...
        <div class="col">
            ...
            <div class="form-group row justify-content-sm-center">
                ...
                <div class="col-sm-2">
                    ...
                    <input type="text" name="ses_h_debut" id="heureDebut" class="form-control text-center"  value="<?= ($session->ses_h_debut) ? date("H:i", strtotime($session->ses_h_debut)) : set_value('ses_id'); ?>">
                    <span class="messerreur" id="alertDebut">&nbsp<?= form_error('ses_h_debut', '<span>', '</span>'); ?></span>
                </div>
                <div class="col-sm-2">
                    <label for="ses_h_fin">Heure fin</label>
                    <input type="text" name="ses_h_fin" id="heureFin" class="form-control text-center" value="<?= ($session->ses_h_fin) ? date("H:i", strtotime($session->ses_h_fin)) : set_value('ses_id'); ?>">
