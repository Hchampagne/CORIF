        ...
        <div class="col">
            ...
            <div class="form-group row justify-content-sm-center"> 
                <div class="col-sm-2">
                    ...
                    <input type="text" name="ses_d_session" id="ses_d_session" class="form-control text-center" value="<?= set_value('ses_h_fin') ?>">
                    <span class="messerreur" id="alertSesDate">&nbsp<?= form_error('ses_date', '<span>', '</span>'); ?></span>
                </div>
                <div class="col-sm-2">
                    <label for="ses_h_debut">Heure début</label>
                    <input type="time" name="ses_h_debut" id="ses_h_debut" class="form-control text-center" value="<?= set_value('ses_h_debut') ?>">
