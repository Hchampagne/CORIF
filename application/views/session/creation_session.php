        ...
        <div class="col">
            ...
            <div class="form-group row justify-content-sm-center">
                <div class="col-sm-2">
                    ...
                    <input type="text" name="ses_d_session" id="ses_d_session" class="form-control input-group text-center" placeholder="dd/mm/yyyy" value="<?= set_value('ses_d_session') ?>">                  
                    <span class="messerreur" id="alertDate">&nbsp<?= form_error('ses_d_session', '<span>', '</span>'); ?></span>
                </div>
                <div class="col-sm-2">
                    <label for="ses_h_debut">Heure début</label>
                    <input type="text" name="ses_h_debut" id="heureDebut" class="form-control text-center" placeholder="hh:mm" value="<?= set_value('ses_h_debut') ?>">
                    <span class="messerreur" id="alertDebut">&nbsp<?= form_error('ses_h_debut', '<span>', '</span>'); ?></span>
                </div>
                <div class="col-sm-2">
                    <label for="ses_h_fin">Heure fin</label>
                    <input type="text" name="ses_h_fin" id="heureFin" class="form-control text-center" placeholder="hh:mm" value="<?= set_value('ses_h_fin') ?>">
