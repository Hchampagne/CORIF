    ...
    <div class="row">
        <div class="col">
            ...
            <div class="form-group row justify-content-center">
                <label for="_____________c" class="col-sm-1 col-form-label ">Nom</label>
                <div class="col-sm-5">
            ...
            <div class="form-group row justify-content-center">
                ...
                <div class="col-sm-5">
                    <input type="text" name="invConn_email" id="invConn_email" class="form-control" value="<?= set_value('invConn_nom') ?>">
