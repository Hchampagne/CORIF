<div class="container ">
    ...
    <div class="row">
        <div class="col">
            ...
            <?= form_open('Espace_jeu/connexion_jeu/'.$id_session, 'id="form_connexionJeu"'); ?>

            <div class="form-group row justify-content-center">
                <label for="invConn_nom" class="col-sm-1 col-form-label ">Nom</label>
                <div class="col-sm-5">
                    <input type="text" name="invConn_nom" id="invConn_nom" class="form-control" value="<?= set_value('invConn_nom') ?>">
            ...
            <div class="form-group row justify-content-center">
                ...
                <div class="col-sm-5">
                    <input type="text" name="invConn_email" id="invConn_email" class="form-control" value="<?= set_value('invConn_email') ?>">
